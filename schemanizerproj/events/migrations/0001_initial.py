...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.User'], null=True, on_delete=models.SET_NULL, blank=True)),
        ))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['users.User']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        u'users.role': {
