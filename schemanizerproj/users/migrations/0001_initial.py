...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('roles', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='developer', max_length=255)),
        ))
        ...
        db.create_table('users', (
            ...
            ('github_login', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('auth_user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='schemanizer_user', unique=True, to=orm['auth.User'])),
        ))
