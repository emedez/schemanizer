...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('changesets', (
            ...
            ('review_version', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', db_column='review_version', on_delete=models.SET_NULL, default=None, to=orm['schemaversions.SchemaVersion'], null=True)),
