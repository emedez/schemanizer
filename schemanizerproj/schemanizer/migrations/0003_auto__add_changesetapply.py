...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('changeset_applies', (
            ...
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['schemanizer.Server'], null=True, db_column='server_id', blank=True)),
            ('before_apply_checksum', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('applied_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('applied_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['schemanizer.User'], null=True, db_column='applied_by', blank=True)),
        ))
    ...
    models = {
        ...
        u'schemanizer.changesetapply': {
            ...
            'before_apply_checksum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
