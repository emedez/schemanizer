...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChangesetDetail.revert_verification_sql'
        db.add_column('changeset_details', 'revert_verification_sql',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChangesetDetail.revert_verification_sql'
        db.delete_column('changeset_details', 'revert_verification_sql')
