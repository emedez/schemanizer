...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Server.hostname'
        db.alter_column('servers', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'Changeset.before_version'
        db.add_column('changesets', 'before_version',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', db_column='before_version', default=None, to=orm['schemanizer.SchemaVersion'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Changeset.after_version'
        db.add_column('changesets', 'after_version',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', db_column='after_version', default=None, to=orm['schemanizer.SchemaVersion'], blank=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Server.hostname'
        db.alter_column('servers', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Deleting field 'Changeset.before_version'
        db.delete_column('changesets', 'before_version')

        # Deleting field 'Changeset.after_version'
        db.delete_column('changesets', 'after_version')
