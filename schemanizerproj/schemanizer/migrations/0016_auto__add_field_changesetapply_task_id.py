...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChangesetApply.task_id'
        db.add_column('changeset_applies', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChangesetApply.task_id'
        db.delete_column('changeset_applies', 'task_id')
