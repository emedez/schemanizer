...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChangesetApply.results_log'
        db.add_column('changeset_applies', 'results_log',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChangesetApply.success'
        db.add_column('changeset_applies', 'success',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChangesetApply.results_log'
        db.delete_column('changeset_applies', 'results_log')

        # Deleting field 'ChangesetApply.success'
        db.delete_column('changeset_applies', 'success')
