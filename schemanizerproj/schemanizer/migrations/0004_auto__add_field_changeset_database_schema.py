...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changeset.database_schema'
        db.add_column('changesets', 'database_schema',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='changesets', null=True, db_column='database_schema_id', to=orm['schemanizer.DatabaseSchema']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changeset.database_schema'
        db.delete_column('changesets', 'database_schema_id')
