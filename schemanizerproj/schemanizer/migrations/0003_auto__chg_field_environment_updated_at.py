...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Environment.updated_at' to match new field type.
        db.rename_column('environments', 'updated_at', 'update_at')
        # Changing field 'Environment.updated_at'
        db.alter_column('environments', 'update_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, db_column='update_at'))

    def backwards(self, orm):

        # Renaming column for 'Environment.updated_at' to match new field type.
        db.rename_column('environments', 'update_at', 'updated_at')
        # Changing field 'Environment.updated_at'
        db.alter_column('environments', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True))
