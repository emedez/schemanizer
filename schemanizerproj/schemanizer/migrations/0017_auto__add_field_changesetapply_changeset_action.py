...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChangesetApply.changeset_action'
        db.add_column('changeset_applies', 'changeset_action',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['schemanizer.ChangesetAction'], null=True, db_column='changeset_action_id', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChangesetApply.changeset_action'
        db.delete_column('changeset_applies', 'changeset_action_id')
