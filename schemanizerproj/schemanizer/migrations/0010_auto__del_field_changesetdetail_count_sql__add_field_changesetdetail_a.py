...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChangesetDetail.count_sql'
        db.delete_column('changeset_details', 'count_sql')

        # Adding field 'ChangesetDetail.apply_verification_sql'
        db.add_column('changeset_details', 'apply_verification_sql',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChangesetDetail.count_sql'
        db.add_column('changeset_details', 'count_sql',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'ChangesetDetail.apply_verification_sql'
        db.delete_column('changeset_details', 'apply_verification_sql')
