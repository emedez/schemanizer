...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChangesetAction.type'
        db.alter_column('changeset_actions', 'type', self.gf('django.db.models.fields.CharField')(max_length=34, null=True))

    def backwards(self, orm):

        # Changing field 'ChangesetAction.type'
        db.alter_column('changeset_actions', 'type', self.gf('django.db.models.fields.CharField')(max_length=18))
