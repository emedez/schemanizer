...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('changeset_detail_applies', (
            ...
            ('before_version', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('after_version', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
