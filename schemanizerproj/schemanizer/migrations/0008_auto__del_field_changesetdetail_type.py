...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChangesetDetail.type'
        db.delete_column('changeset_details', 'type')


    def backwards(self, orm):
        # Adding field 'ChangesetDetail.type'
        db.add_column('changeset_details', 'type',
                      self.gf('django.db.models.fields.CharField')(default=u'add', max_length=6, blank=True),
                      keep_default=False)
