...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('changesets', (
            ...
            ('database_schema', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='changesets', null=True, db_column='database_schema_id', to=orm['schemaversions.DatabaseSchema'])),
            ...
            ('reviewed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reviewed_changesets', null=True, db_column='reviewed_by', to=orm['users.User'])),
            ('reviewed_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('approved_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='approved_changesets', null=True, db_column='approved_by', to=orm['users.User'])),
            ('approved_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='submitted_changesets', null=True, db_column='submitted_by', to=orm['users.User'])),
            ...
            ('before_version', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', db_column='before_version', default=None, to=orm['schemaversions.SchemaVersion'], blank=True, null=True)),
            ('after_version', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', db_column='after_version', default=None, to=orm['schemaversions.SchemaVersion'], blank=True, null=True)),
            ('repo_filename', self.gf('django.db.models.fields.TextField')(default=None, null=True, db_column='repo_filename', blank=True)),
        ))
        ...
        db.create_table('changeset_details', (
            ...
            ('apply_verification_sql', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('revert_verification_sql', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ...
        db.create_table('changeset_detail_applies', (
            ...
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='environment_changeset_detail_applies', null=True, to=orm['servers.Environment'])),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='server_changeset_detail_applies', null=True, to=orm['servers.Server'])),
        ...
        db.create_table('changeset_tests', (
            ...
            ('environment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['servers.Environment'], null=True, blank=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['servers.Server'], null=True, blank=True)),
        ...
        db.create_table('changeset_reviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.OneToOneField')(null=True, db_column='changeset_id', default=None, to=orm['schemanizer.Changeset'], blank=True, unique=True)),
            ('results_log', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('task_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=36, null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'schemanizer', ['ChangesetReview'])

        # Adding model 'ChangesetApply'
        db.create_table('changeset_applies', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changeset', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['schemanizer.Changeset'], null=True, db_column='changeset_id', blank=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['servers.Server'], null=True, blank=True)),
            ('applied_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('applied_by', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.User'], null=True, db_column='applied_by', blank=True)),
            ('results_log', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('task_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=36, null=True, blank=True)),
            ('changeset_action', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['schemanizer.ChangesetAction'], null=True, db_column='changeset_action_id', blank=True)),
        ))
        db.send_create_signal(u'schemanizer', ['ChangesetApply'])
        ...
        db.send_create_signal(u'schemanizer', ['ChangesetActionServerMap'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ChangesetApply'
        db.delete_table('changeset_applies')
    ...
    models = {
        ...
        u'schemanizer.changeset': {
            ...
            'after_version': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'db_column': "'after_version'", 'default': 'None', 'to': u"orm['schemaversions.SchemaVersion']", 'blank': 'True', 'null': 'True'}),
            'approved_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'approved_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'approved_changesets'", 'null': 'True', 'db_column': "'approved_by'", 'to': u"orm['users.User']"}),
            'before_version': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'db_column': "'before_version'", 'default': 'None', 'to': u"orm['schemaversions.SchemaVersion']", 'blank': 'True', 'null': 'True'}),
            'classification': ('django.db.models.fields.CharField', [], {'default': "u'painless'", 'max_length': '10', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'database_schema': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'changesets'", 'null': 'True', 'db_column': "'database_schema_id'", 'to': u"orm['schemaversions.DatabaseSchema']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_deleted': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'repo_filename': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'db_column': "'repo_filename'", 'blank': 'True'}),
            ...
            'reviewed_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reviewed_changesets'", 'null': 'True', 'db_column': "'reviewed_by'", 'to': u"orm['users.User']"}),
            'submitted_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'submitted_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'submitted_changesets'", 'null': 'True', 'db_column': "'submitted_by'", 'to': u"orm['users.User']"}),
        ...
        u'schemanizer.changesetactionservermap': {
            'Meta': {'object_name': 'ChangesetActionServerMap', 'db_table': "'changeset_action_server_map'"},
            'changeset_action': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['schemanizer.ChangesetAction']", 'null': 'True', 'db_column': "'changeset_action_id'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'schemanizer.changesetapply': {
            ...
            'applied_by': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['users.User']", 'null': 'True', 'db_column': "'applied_by'", 'blank': 'True'}),
            ...
            'changeset_action': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['schemanizer.ChangesetAction']", 'null': 'True', 'db_column': "'changeset_action_id'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'results_log': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'server': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['servers.Server']", 'null': 'True', 'blank': 'True'}),
        ...
        u'schemanizer.changesetdetail': {
            ...
            'apply_verification_sql': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'revert_verification_sql': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'schemanizer.changesetdetailapply': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'environment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'environment_changeset_detail_applies'", 'null': 'True', 'to': u"orm['servers.Environment']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'results_log': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'server': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'server_changeset_detail_applies'", 'null': 'True', 'to': u"orm['servers.Server']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'schemanizer.changesetreview': {
            'Meta': {'object_name': 'ChangesetReview', 'db_table': "'changeset_reviews'"},
            'changeset': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'db_column': "'changeset_id'", 'default': 'None', 'to': u"orm['schemanizer.Changeset']", 'blank': 'True', 'unique': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'results_log': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'success': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'schemanizer.changesettest': {
            ...
            'environment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['servers.Environment']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'results_log': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'server': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['servers.Server']", 'null': 'True', 'blank': 'True'}),
