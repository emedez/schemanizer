...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChangesetDetailApply.after_version'
        db.delete_column('changeset_detail_applies', 'after_version')

        # Deleting field 'ChangesetDetailApply.before_version'
        db.delete_column('changeset_detail_applies', 'before_version')


    def backwards(self, orm):
        # Adding field 'ChangesetDetailApply.after_version'
        db.add_column('changeset_detail_applies', 'after_version',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChangesetDetailApply.before_version'
        db.add_column('changeset_detail_applies', 'before_version',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
