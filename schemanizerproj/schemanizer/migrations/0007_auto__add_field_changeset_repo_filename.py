...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Changeset.repo_filename'
        db.add_column('changesets', 'repo_filename',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, db_column='repo_filename', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Changeset.repo_filename'
        db.delete_column('changesets', 'repo_filename')
