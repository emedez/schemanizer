...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChangesetReview.changeset'
        db.alter_column('changeset_reviews', 'changeset_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, db_column='changeset_id', to=orm['schemanizer.Changeset'], unique=True))
        # Adding unique constraint on 'ChangesetReview', fields ['changeset']
        db.create_unique('changeset_reviews', ['changeset_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ChangesetReview', fields ['changeset']
        db.delete_unique('changeset_reviews', ['changeset_id'])


        # Changing field 'ChangesetReview.changeset'
        db.alter_column('changeset_reviews', 'changeset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schemanizer.Changeset'], null=True, db_column='changeset_id'))
