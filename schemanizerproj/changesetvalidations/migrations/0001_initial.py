...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('validation_types', (
            ...
            ('validation_commands', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'changesetvalidations', ['ValidationType'])
        ...
        db.create_table('changeset_validations', (
            ...
            ('validation_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['changesetvalidations.ValidationType'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('result', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'changesetvalidations', ['ChangesetValidation'])
    ...
    models = {
        ...
        u'changesetvalidations.changesetvalidation': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'validation_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['changesetvalidations.ValidationType']"})
        },
        u'changesetvalidations.validationtype': {
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'validation_commands': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
    ...
    complete_apps = ['changesetvalidations']